...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self, patches_xy, patches_xz, patches_yz,
        ...
        self.next_positive_shortcut = QShortcut(QKeySequence("Ctrl+N"), self)
        self.next_positive_shortcut.activated.connect(self.imageNextPositive)
        self.next_negative_shortcut = QShortcut(QKeySequence("Ctrl+X"), self)
        ...
        self.mark_menu.addAction("&Astrocyte", self.markAstrocyde)
        self.mark_menu.addAction("&Microglia", self.markMicroglia)
        self.mark_menu.addAction("&Pericyte", self.markPericyte)
        self.mark_menu.addAction("&Undo", self.markUndo,
                                 QtCore.Qt.CTRL + QtCore.Qt.Key_Z)
        self.menuBar().addMenu(self.mark_menu)
        self.mark_positive_shortcut = QShortcut(QKeySequence("N"), self)
        self.mark_positive_shortcut.activated.connect(self.markPositive)
        self.mark_negative_shortcut = QShortcut(QKeySequence("X"), self)
        ...
        self.mark_microglia_shortcut = QShortcut(QKeySequence("M"), self)
        self.mark_microglia_shortcut.activated.connect(self.markMicroglia)
        self.mark_pericyte_shortcut = QShortcut(QKeySequence("P"), self)
        self.mark_pericyte_shortcut.activated.connect(self.markPericyte)
